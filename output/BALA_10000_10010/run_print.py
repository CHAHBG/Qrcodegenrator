...
def create_qr_pdf(input_folder, output_pdf, images_per_row=4, rows_per_page=2, margin=30, row_spacing=20):
    ...
    # Use numerical sort if possible to keep order
    try:
    ...
    # 4 columns, 2 rows = 8 images per page
    # Calculate available space
    # The original script had logic for this. copying it.
    ...
    if available_ratio > original_ratio:
        qr_height = available_height * 0.9
        qr_width = qr_height * original_ratio
    else:
        qr_width = available_width * 0.9
    ...
    for i, image_file in enumerate(image_files):
        ...
        try:
            ...
            # Resize for consistency ? Original script did.
            # optimize speed? no need for now.
...
if __name__ == "__main__":
    create_qr_pdf(r"C:\\Users\\ASUS\\Documents\\Procasef_BETPLUS\\Application\\DashBoard\\Dashnoard\\WebQRCodeGenerator\\output\\BALA_10000_10010", r"C:\\Users\\ASUS\\Documents\\Procasef_BETPLUS\\Application\\DashBoard\\Dashnoard\\WebQRCodeGenerator\\output\\BALA_10000_10010\\BALA_10000_10010.pdf")
